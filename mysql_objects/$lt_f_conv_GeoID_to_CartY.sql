...
-- Exportiere Struktur von Funktion lif_883350.$lt_f_conv_GeoID_to_CartY
DROP FUNCTION IF EXISTS `$lt_f_conv_GeoID_to_CartY`;
DELIMITER //
CREATE FUNCTION `$lt_f_conv_GeoID_to_CartY`(`in_GeoID` INT) RETURNS int(11)
    DETERMINISTIC
BEGIN
